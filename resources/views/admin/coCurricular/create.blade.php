...
@section('title', 'পরীক্ষা ও পরীক্ষার ফলাফল তৈরি করুন')
@section('content-header', 'পরীক্ষা ও পরীক্ষার ফলাফল তৈরি করুন')

@section('content')
    <div class="card">
        <div class="card-body">

            <form action="{{ route('coCurricular.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="exam_name" class="form-control @error('exam_name') is-invalid @enderror"
                        id="exam_name" placeholder="পরীক্ষার নাম লিখুন" value="{{ old('exam_name') }}">
                    @error('exam_name')
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="exam_year" class="form-control @error('exam_year') is-invalid @enderror"
                        id="exam_year" placeholder="পরীক্ষার সাল লিখুন" value="{{ old('exam_year') }}">
                    @error('exam_year')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="total_candidates" class="form-control @error('total_candidates') is-invalid @enderror"
                        id="total_candidates" placeholder="পরীক্ষার্থীদের সংখ্যা লিখুন" value="{{ old('total_candidates') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="attended_candidates" class="form-control @error('attended_candidates') is-invalid @enderror"
                        id="attended_candidates" placeholder="উপস্থিতি সংখ্যা লিখুন" value="{{ old('attended_candidates') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="a_plus_holder" class="form-control @error('a_plus_holder') is-invalid @enderror"
                        id="a_plus_holder" placeholder="এ+ প্রাপ্ত সংখ্যা লিখুন" value="{{ old('a_plus_holder') }}">
                    @error('a_plus_holder')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="total_pass" class="form-control @error('total_pass') is-invalid @enderror"
                        id="total_pass" placeholder="মোট পাস এর সংখ্যা" value="{{ old('total_pass') }}">
                    @error('total_pass')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="pass_rate" class="form-control @error('pass_rate') is-invalid @enderror"
                        id="pass_rate" placeholder="মোট পাসের হার" value="{{ old('pass_rate') }}">
                    @error('pass_rate')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
