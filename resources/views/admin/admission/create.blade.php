...
@section('title', 'ভর্তি- সংক্রান্ত কার্যক্রম তৈরি করুন')
@section('content-header', 'ভর্তি- সংক্রান্ত কার্যক্রম তৈরি করুন')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('admission.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <a href="{{ route('admission.index') }}" class="btn btn-danger">বাতিল করুন</a>
            </form>
        </div>
    </div>
@endsection
