...
@section('title', 'শিক্ষকমন্ডলী তৈরি করুন')
@section('content-header', 'শিক্ষকমন্ডলী তৈরি করুন')
            ...
            <form action="{{ route('teachers.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" required name="name" class="form-control @error('name') is-invalid @enderror"
                        id="name" placeholder="শিক্ষকের নাম লিখুন" value="{{ old('name') }}">
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <input type="email" required name="email" class="form-control @error('email') is-invalid @enderror"
                        id="email" placeholder="শিক্ষকের ই-মেইল লিখুন" value="{{ old('email') }}">
                    @error('email')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="designation" required  class="form-control @error('designation') is-invalid @enderror"
                        id="designation" placeholder="শিক্ষকের উপাধি লিখুন" value="{{ old('designation') }}">
                    @error('designation')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="phone" required  class="form-control @error('phone') is-invalid @enderror"
                        id="phone" placeholder="শিক্ষকের মোবাইল-নং লিখুন" value="{{ old('phone') }}">
                    @error('phone')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text"  required name="lastDegree" class="form-control @error('lastDegree') is-invalid @enderror"
                        id="lastDegree" placeholder="সর্বশেষ ডিগ্রি লিখুন" value="{{ old('lastDegree') }}">
                    @error('lastDegree')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
